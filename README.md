...
```
cd existing_repo
git remote add origin https://gitlab.com/bailleul/redmine-subtasks-plugin.git
git branch -M main
...
- [ ] [Set up project integrations](https://gitlab.com/bailleul/redmine-subtasks-plugin/-/settings/integrations)
